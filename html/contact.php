      ...
      <section id="main-section">
        <div class="wrapper">
          <div id="form-container">
            <h1 class="animation" data-animation="fadeIn">Contact</h1>
            ...
            <form id="form" action="<?php echo $page ?>" method="post">
              ...
              <div id="contact-form" class="grid-field-container">
                <div class="field" class="animation" data-animation="moveToLeft">
                  <label for="lastname">
                    <input type="text" name="lastname" id="lastname" placeholder="Nom *">
                  </label>
                </div>

                <div class="field" class="animation" data-animation="moveToRight">
                  <label for="firstname">
              ...
              <div class="field" class="animation" data-animation="scaleUp">
                <label for="message">
                  <textarea name="message" id="message" placeholder="Message" rows="10"></textarea>
                </label>
              </div>

              <div class="field" class="animation" data-animation="scaleDown">
